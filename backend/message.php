	...
	$message = <<<LABEL
		<html>
			...
			<body dir="rtl" style="text-align: right;">
				...
				<div><span class="form_output_col_1">אימייל: </span><a dir="ltr" href="mailto:" class="form_output_col_2">$email</a></div>
				<div><span class="form_output_col_1">טלפון: </span><a dir="ltr" href="tel:" class="form_output_col_2">$phone</a></div>
				<div><span class="form_output_col_1">נושא: <span class="form_output_col_2">$topic</span></div>
				<div><span class="form_output_col_1">אתר: </span><a type="url" href="" dir="ltr" class="form_output_col_2">$url</a></div>
