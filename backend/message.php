	...
	$message = <<<LABEL
		<html>
			...
			<body dir="rtl" style="text-align: right;">
				...
				<div><span class="form_output_col_1">אימייל: </span><span dir="ltr" href="mailto:" class="form_output_col_2">$email</span></div>
				<div><span class="form_output_col_1">טלפון: </span><span dir="ltr" href="tel:" class="form_output_col_2">$phone</span></div>
				<div><span class="form_output_col_1">נושא: <span class="form_output_col_2">$topic</span></div>
				<div><span class="form_output_col_1">אתר: </span><span type="url" href="" dir="ltr" class="form_output_col_2">$url</span></div>
