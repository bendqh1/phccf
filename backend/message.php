	...
	$message = <<<LABEL
		<html>
			...
			<body dir="rtl" style="text-align: right;">
				...
				<div><span class="form_output_col_1">אימייל: </span><a href="mailto:$email" dir="ltr" class="form_output_col_2">$email</a></div>
				...
				<div><span class="form_output_col_1">אתר: </span><a href="$url" dir="ltr" class="form_output_col_2">$url</a></div>
