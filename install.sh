...
unzip main.zip
rm main.zip
mv "${website_dir}"/prcf-main/html/contact_form.html "${website_dir}"/contact.html
mv "${website_dir}"/prcf-main/html/contact_form_success.html "${website_dir}"/success.html
